...
L.credit_mn_all    = "Маньяки, вы награждены кредитами ({num}) за ваши действия."
...
L.body_found_m     = "Он был маньяком!"
...
L.info_popup_maniac = [[Вы маньяк! Для вас нет правил!
...
L.hilite_win_maniac   = "Победа маньяка"
...
L.ev_win_maniac  = "Безумный маньяк победил!"
